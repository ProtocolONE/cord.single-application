...
#define _GGS_AUTORUNHELPER_VERSION_H_
    ...
    #define FILEDESCRIPTION  "Developer version of Application library"
    #define INTERNALNAME     "Application"
    #define LEGALCOPYRIGHT   "Copyright(c) 2010 - 2012"

    #ifdef DEBUG 
        #define ORIGINALFILENAME "ApplicationX86d.dll"
    #else
        #define ORIGINALFILENAME "ApplicationX86.dll"
    #endif

    #define PRODUCTNAME      "Application library"
#else
